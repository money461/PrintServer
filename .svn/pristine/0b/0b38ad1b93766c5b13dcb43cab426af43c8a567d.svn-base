...
public class PermissionServiceLocator extends org.apache.axis.client.Service implements org.tempuri.PermissionService {
    ...
    public org.tempuri.IPermissionService getBasicHttpBinding_IPermissionService() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.IPermissionService getBasicHttpBinding_IPermissionService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.BasicHttpBinding_IPermissionServiceStub _stub = new org.tempuri.BasicHttpBinding_IPermissionServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.IPermissionService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.BasicHttpBinding_IPermissionServiceStub _stub = new org.tempuri.BasicHttpBinding_IPermissionServiceStub(new java.net.URL(BasicHttpBinding_IPermissionService_address), this);
                _stub.setPortName(getBasicHttpBinding_IPermissionServiceWSDDServiceName());
                return _stub;
            }
        }
