/**
  ...
  */
package com.bondex.security.entity;
...
public class JsonResult {
	...
	public void setPrintbuttonindex(int Printbuttonindex) {
		this.Printbuttonindex = Printbuttonindex;
	}

	public int getPrintbuttonindex() {
		return Printbuttonindex;
	}
