package com.bondex.mapper.provider;
...
import com.bondex.annoation.dao.Invisible;
           ...
           sb.append("<where>");
	           ...
	           for (Field field : parameterType.getDeclaredFields()) {                
	        	   ...
	        	   if (!field.isAnnotationPresent(Invisible.class)) {
	                   ...
	                   sb.append(tmp.replaceAll("_field", field.getName()).replaceAll("_column",CaseFormat.LOWER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE, field.getName()))); //TestData  -> test_data
	        		   
	                  /* String tmp = "<if test=\"_field != null\"> AND _column like concat('%',#{_field},'%')</if>";
