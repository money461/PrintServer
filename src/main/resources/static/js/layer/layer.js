...
;! function(e, t) {"use strict";
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        if (!t.id || !i("#"+t.id)[0]) {
            switch("string"==typeof t.area&&(t.area="auto"===t.area?["",""]:[t.area,""]),t.shift&&(t.anim=t.shift),6==r.ie&&(t.fixed=!1),t.type) {
                ...
                case 3:
                    delete t.title,
                    delete t.closeBtn, t.icon === -1 && 0 === t.icon, r.closeAll("loading");
                    break;
                case 4:
        ...
        var s = {
            ...
            top : r.offset().top+$("body").scrollTop(),
            left : r.offset().left+$("body").scrollLeft()
        ...
        return t.move && l.css("cursor", "move"), l.on("mousedown", function(e) {
            ...
            c.moveStart && (
            delete c.moveStart, o.moveElem.hide(), t.moveEnd && t.moveEnd(s)), c.resizeStart && (
    ...
    r.prompt = function(e, t) {
        ...
        return
        delete e.success, r.open(i.extend({
            type : 1,
            btn : ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
            content : l,
